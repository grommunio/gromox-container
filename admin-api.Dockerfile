...
COPY  ./config_files/antispam.conf /usr/share/grommunio-admin-common/nginx.d/antispam.conf

COPY  ./config_files/admin_web_config.json /usr/share/grommunio-admin-web/config.json

COPY  ./config_files/admin_api_config.yaml /etc/grommunio-admin-api/conf.d/config.yaml
