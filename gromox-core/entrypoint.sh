...
postconf -e \
  ...
  smtpd_tls_exclude_ciphers="aNULL,eNULL,EXP,MD5,RC4,DES,3DES,DHE,EDH,kDHE,kEDH" \
...
postconf -P submission/inet/smtpd_tls_exclude_ciphers="aNULL,eNULL,EXP,MD5,RC4,DES,3DES,DHE,EDH,kDHE,kEDH"
